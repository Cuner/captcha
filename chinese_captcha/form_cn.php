...
<a href="javascript:void(0)" onclick="document.getElementById('captcha_img').src='./CAPTCHA_cn.php?r='+Math.random()">换一个？</a><br>
请输入图片内容：<input type="text" name="authcode"><br>
<input type="submit">
</from>
</body>
</html>
